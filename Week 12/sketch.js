...
if (second() %2 === 0){
 ...
 rotate (c);
    ...
    fill(random(255), i*20, 255-i *20);
    
    ellipse(400 - x ,200, 10); //future obstacle
    ellipse(200, x* 1.05, 10); //future obstacle
    ellipse(200, 400 - x, 10); //future obstacle
    ellipse(200, 400, y, 10); //future obstacle
